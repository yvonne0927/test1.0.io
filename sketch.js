...
// 使用函数创建多个悬挂的球
createHangingBall(windowWidth/25, 150*2, 20, world, 'target');
createHangingBall(windowWidth/25*24, 190*2, 30, world, 'target');
createHangingBall(windowWidth/25*23, 130*2, 20, world, 'target');
createHangingBall(windowWidth/25*22, 170*2, 25, world,  'target');
createHangingBall(windowWidth/25*21, 120*2, 25, world, 'target');
createHangingBall(windowWidth/25*20, 150*2, 30, world, 'target');
createHangingBall(windowWidth/25*19, 120*2, 30, world, 'target');
createHangingBall(windowWidth/25*18, 170*2, 25, world, 'target');
createHangingBall(windowWidth/25*17, 140*2, 30, world, 'target');
createHangingBall(windowWidth/25*16, 160*2, 30,world,  'target');
createHangingBall(windowWidth/25*15, 200*2, 35,world,'target');
createHangingBall(windowWidth/25*13, 170*2, 20,world,'target' );
createHangingBall(windowWidth/25*12, 170*2, 25,world,'target');
createHangingBall(windowWidth/25*11, 140*2, 30, world,'target');
createHangingBall(windowWidth/25*10, 160*2, 30,world, 'target');
createHangingBall(windowWidth/25*9, 200*2, 35, world,'target');
createHangingBall(windowWidth/25*8, 150*2, 25, world,'target');
createHangingBall(windowWidth/25*7, 190*2, 30,world, 'target');
createHangingBall(windowWidth/25*6, 140*2, 35, world,'target');
createHangingBall(windowWidth/25*5, 170*2, 25, world,'target');
createHangingBall(windowWidth/25*4, 120*2, 15, world,'target');
createHangingBall(windowWidth/25*3, 130*2, 30, world,'target');
createHangingBall(windowWidth/25*2, 140*2, 15, world,'target');
createHangingBall(windowWidth/2+30, 170*2, 20, world,'target');
createHangingBall(windowWidth-60, 200*2, 25,world, 'target');
